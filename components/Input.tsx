...
export const Input: React.FC<InputProps> = ({ label, id, unit, ...props }) => {
  return (
    <div className="h-full flex flex-col bg-white dark:bg-slate-600 p-3 rounded-lg shadow-md border border-slate-200 dark:border-slate-500">
      <label htmlFor={id} className="block text-base font-medium text-slate-700 dark:text-slate-300 mb-2">
        {label}
      </label>
      {/* This div will grow and push the input to the bottom */}
